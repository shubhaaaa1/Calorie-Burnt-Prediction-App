...
height = st.sidebar.number_input('Enter the Height of the Person :',min_value=100.0,max_value=230,step=1.0,value=100.0)
weight = st.sidebar.number_input('Enter the Weight of the Person :',min_value=0.0,max_value=150,step=1.0)
